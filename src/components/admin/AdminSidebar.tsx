...
const NAV = [
  ...
  },
  {
    ...
    icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" stroke="currentColor"><path d="M3 3v18h18" /><path d="M7 15l4-4 3 3 5-7" /><path d="M15 7h4v4" /></svg>,
  },
  {
