...
const SECTIONS = [
  ...
  },
  {
    ...
    paras: [
      'The Canadian real estate market moves quickly — but making an uninformed offer is a risk you don't need to take. Our purchasing guidance gives first-time buyers and experienced investors alike the knowledge to act confidently.',
  ...
  },
  {
    ...
    paras: [
      'Whether you're buying a fixer-upper or maintaining a long-held property, smart renovation decisions can significantly boost your home's resale value. We guide you on which improvements offer the best return on investment in the current Canadian market.',
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            {SECTIONS.map(s => (
              <a key={s.id} href={`#${s.id}`}
                style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', color: '#fff', textDecoration: 'none', borderRadius: 8, padding: '9px 16px', fontSize: 13, fontWeight: 500 }}
