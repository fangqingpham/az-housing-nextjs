      ...
      <section style={{ background: "linear-gradient(135deg, #1a3a5c 0%, #0f2a46 100%)", color: "#fff", padding: "clamp(60px,10vw,110px) 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.72)", fontSize: "1.1rem", lineHeight: 1.7, maxWidth: 560, margin: "0 auto 36px" }}>
            Whether you are searching for your first rental or relocating across the country, A-Z Housing gives you the tools and support to find the right place.
          </p>
        ...
        <div style={{ maxWidth: 1060, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 56, alignItems: "center" }}>
          <div>
            ...
            <p style={{ color: "var(--mid)", lineHeight: 1.8, marginBottom: 16 }}>
              Every listing on A-Z Housing includes a secure enquiry form that connects you directly to the landlord or listing agent. Your contact details are never shared publicly.
            </p>
            <p style={{ color: "var(--mid)", lineHeight: 1.8, marginBottom: 24 }}>
              Registered users can also send and track all their enquiries from a single dashboard, so you never lose track of where you are with multiple properties.
            </p>
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            {[
              ...
              { icon: "📬", title: "All Enquiries in One Place", body: "Dashboard inbox consolidates every message you have sent or received." },
