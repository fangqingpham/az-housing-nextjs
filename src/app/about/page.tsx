        ...
        <div style={{ maxWidth: 1060, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 60, alignItems: 'center' }}>
          <div>
            ...
            <h1 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(2rem,5vw,3.2rem)', lineHeight: 1.2, marginBottom: 20 }}>
              Canada's Platform for the <span style={{ color: 'var(--accent)' }}>Full Property Journey</span>
            </h1>
      ...
      <section style={{ background: '#fff', padding: 'clamp(60px,8vw,90px) 24px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--mid)', fontSize: '1.1rem', lineHeight: 1.85 }}>
            To make every stage of the Canadian property journey — from search to signed contract — transparent, informed, and accessible to all. We believe that when buyers, tenants, and landlords are better informed, the entire housing market becomes healthier.
          </p>
        </div>
      </section>
