    ...
    <main style={{ minHeight: "100vh", background: "var(--cream)" }}>
      ...
      <div style={{ maxWidth: 1060, margin: "0 auto", padding: "clamp(48px,6vw,80px) 24px", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 48, alignItems: "start" }}>
        <div>
          ...
          <p style={{ color: "var(--mid)", marginBottom: 28, fontSize: 14 }}>We will get back to you within one business day.</p>
          ...
          {sent ? (
            ...
            <div style={{ background: "#fff", borderRadius: 16, padding: "32px 28px", boxShadow: "0 2px 16px rgba(0,0,0,0.07)", display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button
                ...
                style={{ background: "var(--accent)", color: "#fff", border: "none", borderRadius: 10, padding: "13px 0", fontWeight: 700, fontSize: 15, cursor: "pointer", opacity: (sending || !form.name || !form.email || !form.message) ? 0.6 : 1 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          ...
          <div style={{ background: "var(--dark)", borderRadius: 14, padding: "24px 22px", color: "#fff" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 14, lineHeight: 1.6, marginBottom: 16 }}>Check the Landlord Portal for FAQs, pricing, and getting started guides.</p>
            <a href="/landlord" style={{ background: "var(--accent)", color: "#fff", textDecoration: "none", borderRadius: 8, padding: "10px 20px", fontWeight: 700, fontSize: 13, display: "inline-block" }}>View FAQs</a>
          </div>
        </div>
      </div>
