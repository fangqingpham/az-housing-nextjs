  ...
  return (
    <div className="ov-shell">
      ...
      <div className="ov-header">
        ...
        <Link href="/admin/listings" className="ov-cta">
          + New Listing
        </Link>
      </div>
                ...
                {recentOrders.map(o => (
                  <tr key={o.id}>
                    ...
                    <td>
                      <span
                        className="ov-status"
                        style={{ background: STATUS_COLOR[o.status] + '22', color: STATUS_COLOR[o.status], borderColor: STATUS_COLOR[o.status] + '44' }}
                      >
                        {o.status}
                      </span>
                    </td>
                    <td className="ov-td-date">
      ...
      <style jsx>{`
        ...
        .ov-stat-card {
          background: #fff;
          border: 1px solid rgba(12,21,37,0.08);
          border-radius: 14px;
          padding: 20px 18px;
          text-decoration: none;
          display: flex;
        ...
        @media (max-width: 768px) {
          ...
          .ov-quick { grid-template-columns: repeat(3, 1fr); }
        }
