    ...
    <main style={{{{ minHeight: '100vh', background: 'var(--cream)' }}}}>
      ...
      <div style={{{{ maxWidth: 800, margin: '0 auto', padding: 'clamp(40px,6vw,64px) 24px' }}}}>
        ...
        <div style={{{{ background: '#fff', borderRadius: 14, padding: 'clamp(28px,4vw,48px)', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}}}>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>2. Personal Information We Collect</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>3. How We Use Personal Information</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>4. Consent</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>5. Sharing of Personal Information</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>6. Listings and Public Information</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>7. Third-Party Links and Listings</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>8. Cookies and Analytics</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>9. Retention and Security</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>10. Access, Correction, and Questions</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>11. Children</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>12. Changes to This Privacy Policy</h2>
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontFamily: 'var(--serif)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--dark)', marginBottom: '0.5rem', paddingBottom: '0.4rem', borderBottom: '1px solid #e5e0d8' }}>13. Contact</h2>
